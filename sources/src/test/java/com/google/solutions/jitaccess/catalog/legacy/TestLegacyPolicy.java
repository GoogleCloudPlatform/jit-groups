...
public class TestLegacyPolicy {
  ...
  public void add_whenProjectHasEligibleBindingsForUnacceptablyLongRole() {
    ...
    var projectPolicy = policy
      .system(LegacyPolicy.ProjectPolicy.createName(projectNumber))
      .map(p -> (LegacyPolicy.ProjectPolicy)p);
    assertTrue(projectPolicy.isPresent());
  ...
  public static class RolePolicy {
    ...
    public void fromBinding_whenBindingIsJitEligible() {
      ...
      assertEquals(new EndUserId("user@example.com"), aces.get(0).principal);
      assertEquals(
