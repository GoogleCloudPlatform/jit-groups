...
public class ITestMetaIamClient {
  @Nested
  public class MetaApi {
    private static MetaIamClient.MetaApi createApi(
      @NotNull Credentials credentials
    ) throws GeneralSecurityException, IOException {
      return new MetaIamClient.MetaApi.Builder(
    ...
    public void getIamPolicy_whenUnauthenticated() throws Exception {
      var request = createApi(ITestEnvironment.INVALID_CREDENTIAL)
        .getIamPolicy(
    ...
    public void getIamPolicy_whenCallerLacksPermission() throws Exception {
      var request = createApi(ITestEnvironment.NO_ACCESS_CREDENTIALS)
        .getIamPolicy(
          "/v1/projects/" + ITestEnvironment.PROJECT_ID,
          new GetIamPolicyRequest());
    ...
    public void getIamPolicy_whenResourceInvalid() throws Exception {
      var request = createApi(ITestEnvironment.APPLICATION_CREDENTIALS)
        .getIamPolicy(
          "/v1/something",
          new GetIamPolicyRequest());
