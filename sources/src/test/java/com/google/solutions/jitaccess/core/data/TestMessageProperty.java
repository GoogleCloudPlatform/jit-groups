...
public class TestMessageProperty {
  ...
  void testToString() {
    ...
    var bindingDescription = String.format(
      ...
      "test justification");
    var condition = new Binding()
      .set("expression", expression)
      .set("title", "Activated")
      .set("description", bindingDescription);

    var binding = new Binding()
      .setRole("project/viewer")
      .set("project_id", "project1")
      .setMembers(List.of("example@example.com"))
      .set("conditions", condition);

    assertEquals(
      "{\"data\":{\"members\":[\"example@example.com\"],\"role\":\"project/viewer\",\"project_id\":\"project1\",\"conditions\":{\"expression\":{\"start\":\"11am\",\"end\":\"12pm\"},\"title\":\"Activated\",\"description\":\"Self-approved, justification: test justification\"}},\"attribute\":\"jit-request-approved\"}",
      new MessageProperty(
        binding,
        MessageProperty.MessageOrigin.REQUEST_APPROVED).toString());
  }
  ...
  void whenObjectAreEquivalent_ThenEqualsReturnsTrue() {
    ...
    var messageProperty1 = new MessageProperty(
      binding1,
      MessageProperty.MessageOrigin.REQUEST_APPROVED);

    var messageProperty2 = new MessageProperty(
      binding2,
      MessageProperty.MessageOrigin.REQUEST_APPROVED);
