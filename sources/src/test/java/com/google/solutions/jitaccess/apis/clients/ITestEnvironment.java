...
public class ITestEnvironment {
  ...
  private static @NotNull String getMandatory(
  ...
  private static @Nullable String getOptional(
    @NotNull Properties properties,
    @NotNull String property,
  ...
  private static @NotNull GoogleCredentials impersonate(
    @NotNull GoogleCredentials source,
